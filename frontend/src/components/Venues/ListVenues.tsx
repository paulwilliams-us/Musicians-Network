              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.equipment}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>EventTypes</p>
                    <p className={'line-clamp-2'}>{item.event_types}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.Venue_Type}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.About}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
