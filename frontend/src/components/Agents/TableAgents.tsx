...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/agents/agentsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureAgentsCols';
...
const TableSampleAgents = ({
  ...
  useEffect(() => {
    if (agentsNotify.showNotification) {
      notify(agentsNotify.typeNotification, agentsNotify.textNotification);
    }
  }, [agentsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/agents/agents-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {agents && Array.isArray(agents) && !showGrid && (
        <CardAgents
          agents={agents}
          loading={loading}
...
export default TableSampleAgents;
