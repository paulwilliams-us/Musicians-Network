...
const ListAvailability = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_AVAILABILITY');
                ...
                >
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter.musiciansOneListFormatter(item.musician)}
                    </p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>AvailableFrom</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.dateTimeFormatter(item.available_from)}
                    </p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>AvailableTo</p>
                    <p className={'line-clamp-2'}>
