...
import { create } from '../../stores/rsvps/rsvpsSlice';
...
RsvpsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_RSVPS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default RsvpsNew;
