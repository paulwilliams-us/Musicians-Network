...
const Dashboard = () => {
  ...
  const [agents, setAgents] = React.useState('Loading...');
  const [applications, setApplications] = React.useState('Loading...');
  const [availability, setAvailability] = React.useState('Loading...');
  const [event_organizers, setEvent_organizers] = React.useState('Loading...');
  const [events, setEvents] = React.useState('Loading...');
  const [jobs, setJobs] = React.useState('Loading...');
  const [musicians, setMusicians] = React.useState('Loading...');
  const [rsvps, setRsvps] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_AVAILABILITY') && (
            <Link href={'/availability/availability-list'}>
              <div className='rounded dark:bg-dark-900 bg-white border border-pavitra-400 dark:border-dark-700 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiCalendarClock || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
          ...
          {hasPermission(currentUser, 'READ_EVENT_ORGANIZERS') && (
            <Link href={'/event_organizers/event_organizers-list'}>
              <div className='rounded dark:bg-dark-900 bg-white border border-pavitra-400 dark:border-dark-700 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
          ...
          {hasPermission(currentUser, 'READ_MUSICIANS') && (
            <Link href={'/musicians/musicians-list'}>
              <div className='rounded dark:bg-dark-900 bg-white border border-pavitra-400 dark:border-dark-700 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiGuitarAcoustic || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
          ...
          {hasPermission(currentUser, 'READ_RSVPS') && (
            <Link href={'/rsvps/rsvps-list'}>
              <div className='rounded dark:bg-dark-900 bg-white border border-pavitra-400 dark:border-dark-700 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiAccountCheck || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
