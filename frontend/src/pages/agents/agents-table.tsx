...
const AgentsTablesPage = () => {
  ...
  const [filters] = useState([
    { label: 'BusinessInformation', title: 'business_info' },
    { label: 'ContactDetails', title: 'contact_details' },
    { label: 'Contact Email', title: 'Contact_Email' },
    { label: 'Contact Number', title: 'Contact_Number' },
    { label: 'Business Name', title: 'Business_Name' },
  ...
  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_AGENTS');
