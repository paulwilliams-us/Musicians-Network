        ...
        <CardBox>
          ...
          >
            <Form>
              ...
              <FormField label='Organizer' labelFor='organizer'>
                <Field
                  name='organizer'
                  id='organizer'
                  component={SelectField}
                  options={initialValues.organizer}
                  itemRef={'event_organizers'}
                  showField={'name'}
                ></Field>
              </FormField>

              <FormField label='RSVPs' labelFor='rsvps'>
                <Field
                  name='rsvps'
                  id='rsvps'
                  component={SelectFieldMany}
                  options={initialValues.rsvps}
                  itemRef={'rsvps'}
                  showField={'response'}
                ></Field>
              </FormField>
